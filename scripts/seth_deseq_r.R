...
sampleFiles<- c("file1.counts",
                "file2.counts",
                "file3.counts",
                "file4.counts",
                "file5.counts",
                "file6.counts")
sampleNames <- c("tissue1","tissue2","tissue3","tissue4","tissue5","tissue6")
sampleCondition <- c("condA","condA","condA","condB","condB","condB")
sampleTable <- data.frame(sampleName = sampleNames, fileName = sampleFiles, condition = sampleCondition)
treatments = c("condA","condB")
