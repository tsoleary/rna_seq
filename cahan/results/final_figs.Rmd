...
#   stat_bin(color = "grey50", position = "dodge") +
#   geom_vline(xintercept = 0) +
#   labs(x = expression("Tolerance effect size  x  " * sigma[p]^-1),
#        y = "Counts") +
#   xlim(c(-1,1)) +
...
**Figure 5:** Scatter plot of the minor allele frequency versus the tolerance effect size scaled by the phenotypic standard deviation ($\sigma_{p}$) for CT<sub>min</sub> and CT<sub>max</sub>. 
