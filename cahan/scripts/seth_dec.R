...
write.table(res, "cold_deg_ranked_lfc.tsv", col.names = FALSE, row.names = FALSE, quote = FALSE)
...
setwd("/Users/tsoleary/gsea_home/output/dec17/")
GSEA.folder = "my_analysis"
...
setwd("/Users/tsoleary/gsea_home/output/dec17/my_analysis/edb")
samples <- list.files()
