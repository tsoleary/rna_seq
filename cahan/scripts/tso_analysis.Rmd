...
deg_simple_4$groupn <- factor(deg_simple_4$groupn, levels = c("Shared: 6123", 
                                                          "Sig1 Shared: 3218", 
                                                          "Unique: 14",
                                                          "Sig1 Unique: 104",
                                                          "NS: 6438"))
...
## GWAS scatter & density plots (10^-4 & nondistinct)

```{r scatter_and_density_plots_first_plot, fig.height = 7, fig.width = 7}

plot_scatter_side_density_xy(deg_simple_4, 
                             x_ = "log2FoldChange.cold", 
                             y_ = "log2FoldChange.hot",
                             labs_x = "Cold vs Ctrl (L2FC)",
                             labs_y = "Hot vs Ctrl (L2FC)",
...
```{r density_plots_4_first, fig.height = 4, fig.width = 7}
ggplot(deg_simple_4) +
  geom_line(mapping = aes(x = log2FoldChange.hot, color = gwas_g), 
            data = deg_simple_4, stat = "density") +
  geom_line(mapping = aes(x = log2FoldChange.cold, color = gwas_g), 
            linetype = "dashed", data = deg_simple_4, stat = "density") +
  scale_color_manual(values = c("red", "blue", "grey50"), drop = FALSE) +
  labs(x = "log2FoldChange vs. Ctrl", 
       color = "GWAS", 
       caption = "Cold dashed line\nHot solid line") +
